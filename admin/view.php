                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <td><?php echo $bookingid; ?></td>
                                    ...
                                    <td>
                                        <a href="deleteBooking.php?id=<?php echo $row['bookingID']; ?>" class="btn btn-danger btn-sm">
                                            <i class="fas fa-trash"></i> Delete
                                        </a>
                                        <a href="editBooking.php?id=<?php echo $row['bookingID']; ?>" class="btn btn-warning btn-sm">
